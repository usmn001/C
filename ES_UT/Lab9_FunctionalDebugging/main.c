...
SW1=GPIO_PORTF_DATA_R&0x10;             // CHECKING PF4

SW2=GPIO_PORTF_DATA_R&0x01; 	          // CHECKING PF0
...
//Time[i] = (last-now)&0x00FFFFFF;        // 24-bit time difference
//Data[i]=GPIO_PORTF_DATA_R&0x13;         // record PF0,PF1,PF4
//Data[i] = GPIO_PORTF_DATA_R&0x01;     // record PF0
//Data[i] = GPIO_PORTF_DATA_R&0x02;     // record PF1
//Data[i] = GPIO_PORTF_DATA_R&0x10;     // record PF4	
//last = now;
//i++;
//}
Delay();
